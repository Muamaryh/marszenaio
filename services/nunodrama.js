...
const NUNODRAMA_SOURCES = {
  ...
  snackshort:   { name: 'SnackShort',   badge: 'Viral & Dub',    desc: 'Drama pendek romantis dan komedi terpopuler' },
  dotdrama:     { name: 'DotDrama',     badge: 'HD',             desc: 'Serial drama pendek modern' },
  flextv:       { name: 'FlexTV',       badge: 'Global Hit',     desc: 'Katalog drama multi-negara dan multi-bahasa' },
  dramabite:    { name: 'DramaBite',    badge: 'Fast Stream',    desc: 'Drama pendek update cepat setiap hari' },
  anyreel:      { name: 'AnyReel',      badge: 'Asian Drama',    desc: 'Drama romantis dan CEO Asia' },
  soreel:       { name: 'SoReel',       badge: 'Trending',       desc: 'Pilihan drama ranking teratas' },
  stareel:      { name: 'StaReel',      badge: 'Hot',            desc: 'Serial drama billionaire dan werewolf' },
  kalostv:      { name: 'KalosTV',      badge: 'Popular',        desc: 'Drama pendek terfavorit' },
  radreels:     { name: 'RadReels',     badge: 'Terbaru',        desc: 'Koleksi drama pendek rilis terbaru' },
  reelshortv2:  { name: 'ReelShort V2', badge: 'HD Dubbing',     desc: 'Server kedua ReelShort dengan subtitle lengkap' },
  freeshort:    { name: 'FreeShort',    badge: 'Gratis',         desc: 'Serial drama gratis tanpa kunci' },
  nunodrama:    { name: 'NunoDrama',    badge: 'AIO Catalog',    desc: 'Agregator drama pilihan komunitas' },
  meloshort:    { name: 'MeloShort',    badge: 'Romance',        desc: 'Drama cinta manis dan keluarga' },
  shortswave:   { name: 'ShortsWave',   badge: 'Multi-Res',      desc: 'Streaming drama resolusi adaptif' },
  sodareels:    { name: 'SodaReels',    badge: 'Fresh',          desc: 'Serial drama segar dan menarik' },
  vibeshort:    { name: 'VibeShort',    badge: 'Hot',            desc: 'Drama trend media sosial' },
  dramarush:    { name: 'DramaRush',    badge: 'Fast',           desc: 'Drama pendek alur cepat' },
  cubetv:       { name: 'CubeTV',       badge: 'Top Series',     desc: 'Katalog drama dan serial pilihan' },
  lupacine:     { name: 'LupaCine',     badge: 'Pilihan',        desc: 'Drama dan film pendek pilihan' },
  idrama:       { name: 'iDrama',       badge: 'Classic',        desc: 'Drama klasik Asia dan modern' },
  happyshort:   { name: 'HappyShort',   badge: 'Fun',            desc: 'Drama komedi dan romantis ceria' },
  momeshort:    { name: 'MomeShort',    badge: 'Terbaru',        desc: 'Drama rilis baru harian' },
  moreshort:    { name: 'MoreShort',    badge: 'Katalog Luas',   desc: 'Ratusan pilihan judul drama pendek' },
  storygo:      { name: 'StoryGo',      badge: 'Storyline',      desc: 'Drama dengan alur cerita mendalam' },
  minishort:    { name: 'MiniShort',    badge: 'Compact',        desc: 'Drama durasi super ringkas' },
  shorten:      { name: 'Shorten',      badge: 'Trending',       desc: 'Drama pendek populer' },
  mydrama:      { name: 'MyDrama',      badge: 'HD',             desc: 'Koleksi drama pilihan terbaik' },
  huangdou:     { name: 'HuangDou',     badge: 'Chinese Hit',    desc: 'Drama pendek asli Mandarin' },
  ansflix:      { name: 'AnsFlix',      badge: 'Stream',         desc: 'Serial drama dan mini movie' },
  bibishort:    { name: 'BiBiShort',    badge: 'Popular',        desc: 'Drama viral Asia' },
  fundrama:     { name: 'FunDrama',     badge: 'Entertaining',   desc: 'Drama menghibur dan seru' },
  zeroshort:    { name: 'ZeroShort',    badge: 'New',            desc: 'Koleksi drama tanpa batas' },
  dramaora:     { name: 'DramaOra',     badge: 'Kategori Lengkap', desc: 'Drama dengan filter genre lengkap' },
  bumpit:       { name: 'BumpIt',       badge: 'HLS Playlist',   desc: 'Direct HLS streaming multi-source' },
  nunomix:      { name: 'NunoMix',      badge: 'Rekomendasi',    desc: 'Kombinasi drama terbaik' },

  // === DONGHUA & ANIME ===
  donghuaqueen: { name: 'Donghua Queen', badge: 'Donghua HD',     desc: 'Animasi 3D China (Donghua) subtitle Indonesia' },
  samehadaku:   { name: 'Samehadaku',    badge: 'Anime Sub Indo', desc: 'Serial Anime Jepang subtitle Indonesia' },
  animex:       { name: 'AnimeX',        badge: 'Anime Streaming', desc: 'Koleksi anime ongoing & complete' },
  bstation:     { name: 'BStation',      badge: 'Anime & Drama',  desc: 'Serial Bilibili / BStation populer' },
  toonshort:    { name: 'ToonShort',     badge: 'Animasi Pendek', desc: 'Kartun & animasi pendek' },

  // === K-DRAMA & MOVIES ===
  drakorid:     { name: 'DrakorID',      badge: 'K-Drama',        desc: 'Drama Korea dan Movie Korea Sub Indo' },
  lookseries:   { name: 'LookSeries',    badge: 'Film & Series',  desc: 'Serial TV, film, dan kartun streaming' },
  dramaqueen:   { name: 'DramaQueen',    badge: 'Asian Movie',    desc: 'Drama dan film Asia terlengkap' }
};
